...
#define MP8899_VREF_MIN_UV		400000	/* 0.4V */
#define MP8899_VREF_RANGE1_MAX_UV	2047500	/* 2.0475V */
#define MP8899_VREF_RANGE2_MAX_UV	3600000	/* 3.6V */
#define MP8899_VREF_STEP1_UV		500	/* 0.5mV */
#define MP8899_VREF_STEP2_UV		1000	/* 1mV */

/* Timeout and Bit Position Definitions */
#define MP8899_GO_BIT_TIMEOUT_MS	10	/* GO_BIT polling timeout */
#define MP8899_GO_BIT_POLL_INTERVAL_US	10	/* GO_BIT polling interval */
#define MP8899_PG_BIT_BASE		7	/* Power good bit base position */
/* For 0.5mV step (VOUT_SELECT=0): (2.0475V-0.4V)/0.5mV + 1 */
/* For 1mV step (VOUT_SELECT=1): (3600V-400V)/1mV+1 = 3201 */
#define MP8899_N_VOLTAGES		3296	/* Number of voltage steps for 0.5mV mode */
#define MP8899_N_VOLTAGES_1MV		3201	/* Number of voltage steps for 1.0mV mode */

/* Current Limit Definitions */
#define MP8899_CURRENT_LIMIT_2A		0	/* 2A valley current */
#define MP8899_CURRENT_LIMIT_3A		1	/* 3A valley current */
#define MP8899_CURRENT_LIMIT_4_2A	2	/* 4.2A valley current */
#define MP8899_CURRENT_LIMIT_5A		3	/* 5A valley current */

/* Phase Delay Definitions */
#define MP8899_PHASE_DELAY_0		0	/* 0° */
#define MP8899_PHASE_DELAY_90		1	/* 90° */
#define MP8899_PHASE_DELAY_180		2	/* 180° */
#define MP8899_PHASE_DELAY_270		3	/* 270° */
...
#define MP8899_BUCK_CTL_OFFSET		6	/* Offset between buck register sets */
