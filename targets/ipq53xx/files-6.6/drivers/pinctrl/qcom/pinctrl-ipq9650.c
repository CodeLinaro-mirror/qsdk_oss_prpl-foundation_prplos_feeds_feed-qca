...
static const char *const pwm_out40_groups[] = {
	"gpio44",
};

static const char *const pwm_out41_groups[] = {
	"gpio7",
};

static const char *const pwm_out42_groups[] = {
	"gpio35",
};

static const char *const pwm_out50_groups[] = {
	"gpio43",
};

static const char *const pwm_out51_groups[] = {
	"gpio6",
};
...
static const char *const qup_se1_l4_groups[] = {
	"gpio27",
};

static const char *const qup_se1_l5_groups[] = {
	"gpio29",
};
...
static const struct msm_pingroup ipq9650_groups[] = {
	...
	[7] = PINGROUP(7, qup_se0_l3, pwm_out41, _, cri_rng1, qdss_tracedata_a, _, _, _, _, _, _),
	...
	[26] = PINGROUP(26, pcie0_wake, _, _, _, _, _, _, _, _, _, _),
	[27] = PINGROUP(27, pcie1_clk_req_n, qup_se2_l3, qup_se1_l4, _, qdss_cti_trig_out_a1, _, _, _, _, _, _),
	[28] = PINGROUP(28, _, _, _, _, _, _, _, _, _, _, _),
	[29] = PINGROUP(29, pcie1_wake, qup_se2_l2, qup_se1_l5, _, qdss_cti_trig_in_a1, _, _, _, _, _, _),
	...
	[39] = PINGROUP(39, audio_pri_pclk, qup_se7_l1, audio_sec1, audio_sec1, pll_test, rx_los01, _, qdss_tracedata_a, _, _, _),
