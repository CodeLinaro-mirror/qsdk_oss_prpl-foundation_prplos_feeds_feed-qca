PKG_DRIVERS += \
	ath-qca ath5k-qca ath6kl-qca ath6kl-sdio-qca ath6kl-usb-qca ath9k-qca ath9k-common-qca ath9k-htc-qca ath10k-qca \
	ath11k-qca ath11k-ahb-qca ath11k-pci-qca ath12k-qca carl9170 owl-loader
...
config-$(call config_package,ath-qca) += ATH_CARDS ATH_COMMON ATH_REG_DYNAMIC_USER_REG_HINTS
...
config-$(call config_package,ath9k-common-qca) += ATH9K_COMMON
...
config-$(call config_package,ath9k-htc-qca) += ATH9K_HTC
config-$(call config_package,ath10k-qca) += ATH10K ATH10K_PCI
config-$(call config_package,ath11k-qca) += ATH11K ATH11K_AHB ATH11K_SPECTRAL ATH11K_DEBUG ATH11K_CFR
config-$(call config_package,ath11k-pci-qca) += ATH11K_PCI
...
config-$(call config_package,ath6kl-sdio-qca) += ATH6KL_SDIO
config-$(call config_package,ath6kl-usb-qca) += ATH6KL_USB
...
define KernelPackage/ath-qca
  ...
  DEPENDS+= @PCI_SUPPORT||USB_SUPPORT||TARGET_ar71xx||TARGET_ath79||TARGET_ath25 +kmod-mac80211-qca
...
define KernelPackage/ath5k-qca
  ...
  DEPENDS+= @(PCI_SUPPORT||TARGET_ath25) +kmod-ath-qca +@DRIVER_11W_SUPPORT
...
define KernelPackage/ath6kl-qca
  ...
  HIDDEN:=1
  DEPENDS+= +kmod-ath-qca +@DRIVER_11N_SUPPORT
  FILES:= $(PKG_BUILD_DIR)/drivers/net/wireless/ath/ath6kl/ath6kl_core.ko
endef

define KernelPackage/ath6kl-sdio-qca
  $(call KernelPackage/mac80211-qca/Default)
...
define KernelPackage/ath6kl-sdio-qca/description
This module adds support for wireless adapters based on
Atheros IEEE 802.11n AR6003 and AR6004 family of chipsets.
endef

define KernelPackage/ath6kl-usb-qca
  $(call KernelPackage/mac80211-qca/Default)
...
define KernelPackage/ath6kl-usb-qca/description
This module adds support for wireless adapters based on the
Atheros IEEE 802.11n AR6004 chipset.
endef

define KernelPackage/ath9k-common-qca
  $(call KernelPackage/mac80211-qca/Default)
  TITLE:=Atheros 802.11n wireless devices (common code for ath9k and ath9k_htc)
  URL:=https://wireless.wiki.kernel.org/en/users/drivers/ath9k
  HIDDEN:=1
  DEPENDS+= @PCI_SUPPORT||USB_SUPPORT||TARGET_ar71xx||TARGET_ath79 +kmod-ath-qca +@DRIVER_11N_SUPPORT +@DRIVER_11W_SUPPORT
  FILES:= \
...
define KernelPackage/ath9k-qca
  ...
  URL:=https://wireless.wiki.kernel.org/en/users/drivers/ath9k
  DEPENDS+= @PCI_SUPPORT||TARGET_ar71xx||TARGET_ath79 +kmod-ath9k-common-qca
  FILES:= \
...
define KernelPackage/ath9k-qca/config
	...
	config ATH9K_UBNTHSR
		...
		depends on PACKAGE_kmod-ath9k-qca && (TARGET_ar71xx_generic||TARGET_ath79)
		default y

endef

define KernelPackage/ath9k-htc-qca
  $(call KernelPackage/mac80211-qca/Default)
  TITLE:=Atheros 802.11n USB device support
  URL:=https://wireless.wiki.kernel.org/en/users/drivers/ath9k
  DEPENDS+= @USB_SUPPORT +kmod-ath9k-common-qca +kmod-usb-core +ath9k-htc-firmware
  FILES:= \
	$(PKG_BUILD_DIR)/drivers/net/wireless/ath/ath9k/ath9k_htc.ko
  AUTOLOAD:=$(call AutoProbe,ath9k_htc)
endef

define KernelPackage/ath9k-htc-qca/description
This module adds support for wireless adapters based on
...
define KernelPackage/ath10k-qca
  ...
  DEPENDS+= @PCI_SUPPORT +kmod-ath-qca +@DRIVER_11N_SUPPORT +@DRIVER_11AC_SUPPORT +@DRIVER_11W_SUPPORT \
...
define KernelPackage/ath11k-qca
  ...
  DEPENDS+= @TARGET_ipq95xx +kmod-ath-qca +@DRIVER_11N_SUPPORT +@DRIVER_11AC_SUPPORT +@DRIVER_11W_SUPPORT \
...
define KernelPackage/ath11k-ahb-qca
  $(call KernelPackage/mac80211-qca/Default)
...
define KernelPackage/ath11k-pci-qca
  $(call KernelPackage/mac80211-qca/Default)
  TITLE:=Atheros 802.11ax wireless cards support - PCI
  URL:=https://wireless.wiki.kernel.org/en/users/drivers/ath11k
  DEPENDS+= +kmod-ath11k-qca
  FILES:= \
...
define KernelPackage/ath12k-qca
  ...
  MODPARAMS.ath12k:=cold_boot_cal=0 frame_mode=0
endef
...
define KernelPackage/carl9170
  ...
  DEPENDS:=@USB_SUPPORT +kmod-mac80211-qca +kmod-ath-qca +kmod-usb-core +kmod-input-core +@DRIVER_11N_SUPPORT +@DRIVER_11W_SUPPORT +carl9170-firmware
