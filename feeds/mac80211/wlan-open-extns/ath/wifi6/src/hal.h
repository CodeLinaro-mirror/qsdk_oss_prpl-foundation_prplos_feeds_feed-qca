...
#ifndef ATH12K_HAL_WIFI6_H
#define ATH12K_HAL_WIFI6_H
...
extern const struct ath12k_hw_hal_params ath12k_wifi6_hw_hal_params_qcn9074;

extern const struct ath12k_hw_version_map ath12k_wifi6_hw_ver_map[];
...
#define HAL_RX_REFILL_RING_SIZE			32
#define HAL_RX_MON_REFILL_RING_SIZE		4096
#define HAL_RX_MON_STATUS_RING_SIZE		1024
#define HAL_RX_MON_DESC_RING_SIZE		4096
#define HAL_RX_MON_DST_RING_SIZE		4096
...
#define HAL_TCL_RING_HP_QCN9074			0x00002018
...
#define HAL_TCL_STATUS_RING_HP_QCN9074		0x00002030
...
#define HAL_WIFI6_HASH_ROUTING_RING_TCL 0
#define HAL_WIFI6_HASH_ROUTING_RING_SW1 1
#define HAL_WIFI6_HASH_ROUTING_RING_SW2 2
#define HAL_WIFI6_HASH_ROUTING_RING_SW3 3
#define HAL_WIFI6_HASH_ROUTING_RING_SW4 4
#define HAL_WIFI6_HASH_ROUTING_RING_REL 5
#define HAL_WIFI6_HASH_ROUTING_RING_FW  6
...
#define HAL_REO1_RING_HP_QCN9074		0x00003038
#define HAL_REO2_RING_HP_QCN9074		0x00003040
#define HAL_REO1_RING_TP_QCN9074		0x0000303c
...
#define HAL_REO_SW0_RING_HP_QCN9074		0x00003058
...
#define HAL_REO_CMD_HP_QCN9074			0x00003070
...
#define HAL_WBM_IDLE_LINK_RING_HP_QCN9074       0x000030b0
...
#define HAL_WBM0_RELEASE_RING_HP_QCN9074	0x000030c0
...
void ath12k_wifi6_hal_ce_dst_setup(struct ath12k_base *ab,
				   struct hal_srng *srng, int ring_num);
void ath12k_wifi6_hal_srng_dst_hw_init(struct ath12k_base *ab,
				       struct hal_srng *srng, u32 restore_idx);
void ath12k_wifi6_hal_srng_src_hw_init(struct ath12k_base *ab,
				       struct hal_srng *srng, u32 restore_idx);
void ath12k_wifi6_hal_set_umac_srng_ptr_addr(struct ath12k_base *ab,
					     struct hal_srng *srng,
					     enum hal_ring_type type, int ring_num);
int ath12k_wifi6_hal_srng_update_shadow_config(struct ath12k_base *ab,
					       enum hal_ring_type ring_type,
					       int ring_num);
int ath12k_wifi6_hal_srng_get_ring_id(struct ath12k_hal *hal,
				      enum hal_ring_type type,
				      int ring_num, int mac_id);
u32 ath12k_wifi6_hal_ce_get_desc_size(enum hal_ce_desc type);
void ath12k_wifi6_hal_cc_config(struct ath12k_base *ab);
void ath12k_wifi6_hal_cc_config(struct ath12k_base *ab);
u8 ath12k_wifi6_hal_get_idle_link_rbm(struct ath12k_hal *hal, u8 device_id);
void ath12k_wifi6_hal_get_hw_hptp(struct ath12k_base *ab, enum hal_ring_type type,
				  struct hal_srng *srng, uint32_t *hp, uint32_t *tp);
void ath12k_wifi6_hal_ce_src_set_desc(struct hal_ce_srng_src_desc *desc,
				      dma_addr_t paddr,
				      u32 len, u32 id, u8 byte_swap_data);
void ath12k_wifi6_hal_ce_dst_set_desc(struct hal_ce_srng_dest_desc *desc,
				      dma_addr_t paddr);
void
ath12k_wifi6_hal_set_link_desc_addr(struct hal_wbm_link_desc *desc,
				    u32 cookie, dma_addr_t paddr,
				    u8 rbm);
u32
ath12k_wifi6_hal_ce_dst_status_get_length(struct hal_ce_srng_dst_status_desc *desc);
void
ath12k_wifi6_hal_setup_link_idle_list(struct ath12k_base *ab,
				      struct hal_wbm_idle_scatter_list *sbuf,
				      u32 nsbufs, u32 tot_link_desc,
				      u32 end_offset);
void ath12k_wifi6_hal_reoq_lut_addr_read_enable(struct ath12k_base *ab);
void ath12k_wifi6_hal_reoq_lut_addr_read_enable(struct ath12k_base *ab);
void ath12k_wifi6_hal_reoq_lut_set_max_peerid(struct ath12k_base *ab);
void ath12k_wifi6_hal_reoq_lut_set_max_peerid(struct ath12k_base *ab);
void ath12k_wifi6_hal_write_reoq_lut_addr(struct ath12k_base *ab,
					  dma_addr_t paddr);
void ath12k_wifi6_hal_write_reoq_lut_addr(struct ath12k_base *ab,
					  dma_addr_t paddr);

void ath12k_wifi6_hal_write_ml_reoq_lut_addr(struct ath12k_base *ab,
					     dma_addr_t paddr);

void ath12k_wifi6_hal_write_ml_reoq_lut_addr(struct ath12k_base *ab,
					     dma_addr_t paddr);
void ath12k_wifi6_hal_ppeds_cfg_ast_override_map_reg(struct ath12k_base *ab, u8 idx,
						     u32 ppeds_idx_map_val);
void ath12k_wifi6_hal_srng_hw_disable(struct ath12k_base *ab,
				      struct hal_srng *srng);
void *ath12k_wifi6_hal_srng_src_get_cur_desc_n_move_next(struct ath12k_base *ab,
							  struct hal_srng *srng);
void *ath12k_wifi6_hal_srng_src_next_next_peek(struct ath12k_base *ab,
					       struct hal_srng *srng);
...
void *ath12k_hal_srng_src_begin_get_next_entry_nolock_fast(struct hal_srng *srng)
{
	...
	if (next_hp == srng->u.src_ring.cached_tp) {
		srng->u.src_ring.cached_tp = READ_ONCE(*srng->u.src_ring.tp_addr);
		if (next_hp == srng->u.src_ring.cached_tp)
			return NULL;
	}
